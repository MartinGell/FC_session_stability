...
######## OPTIONS ########
# S3 Bucket location
datasetdir = 's3://btc-hcp-trtcneuro/processed/xcpd'

# name the directory to save data to
dataset = 'HCPtrt_cneuro' #'subpop'
...
sub = ['sub-02']
ses = ['ses-001', 'ses-003', 'ses-005', 'ses-007', 'ses-009'] # 009 has barely 11 minutes of data - the lowes of all subjects.

# sub = ['sub-03']
# ses = ['ses-002', 'ses-004', 'ses-005', 'ses-007', 'ses-010']

# sub = ['sub-04']
# ses = ['ses-001', 'ses-003', 'ses-006', 'ses-008', 'ses-010']

# sub = ['sub-05']
# ses = ['ses-002', 'ses-003', 'ses-006', 'ses-009']

# sub = ['sub-06']
# ses = ['ses-001', 'ses-004', 'ses-007', 'ses-008', 'ses-010', 'ses-013']
...
for s_i in sub:
    ...
    for ses_i in ses:
        ...
        if remove_outliers:
            ...
            if np.isnan(std).any():
                print('\nNan values in wb cmd file, using numpy instead...')
